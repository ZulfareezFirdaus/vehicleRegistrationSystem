...
<div id="wrapper">
  <?php include("DashboardOnly.php");?>
   ...
   <div id="page-wrapper">
                <div class="col-lg-14">
                    <br>
                    <h1>&nbsp;&nbsp;&nbsp;&nbsp;Rekod Laporan Kenderaan Staff </h1>
                    <br>
                        <!-- /.panel-heading -->
                <div class="row">
                    <div class="col-lg-14">
            ...
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              &nbsp; &nbsp; &nbsp;Laporan <a href="Dashboard.php" class="alert-link"></a> 
			    ...
			    <th>Jenis Kend 3</th>
                    ...
                    $sql = "SELECT * FROM stafsokongan ORDER BY staffic_number";
                    ...
                    if($row != 0) {
                        while($ro = mysqli_fetch_assoc($query)){
                                        ...
                                        echo "<input type='text' style='display:none' name='class' value='".$ro['staffic_number']."'>";
		           ...
		           echo "<input type='text' style='display:none' name='kenderaan_2' value='".$ro['kenderaan_2']."'>";
                                       ...
                                       echo '<td>
<form method="POST"><button type="submit" name="updatebutton" value='.$ro['staffic_number'].' formaction="updstaff.php" class="btn btn-warning">Update <i class="fa fa-edit"></i>&nbsp;</button></form><form method="POST"> <button type="submit" name="printfis" value='.$ro['staffic_number'].' formaction="staff.php" class="btn btn-success">View Detail</button></form></td>';
                                        echo "</tr>";
                                        echo "</tr>";
  ...
  <td><form method="POST"><button type="submit" name="printALL" value='.$ro['staffic_number'].' formaction="borang5.php" class="btn btn-info">&nbsp;&nbsp;Print All <i class="glyphicon glyphicon-print"></i>&nbsp;&nbsp;</button></form></td>
                                    </table>
                                </div>
                            </div>
                                </div>
