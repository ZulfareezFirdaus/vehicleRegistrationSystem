...
<?php include("DashboardOnly.php");?>
    ...
    <div id="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="page-header">Track & Trace SMKTG</h1> 
                </div>
            </div>
                                    <div class="col-lg-6">
                                   
<form role="form" method="post" action="TrackTrace2.php">
                                            <div>
                                                <div class="form-group input-group">
                                                    <span class="input-group-addon">No Pendaftaran Kenderaan</span>
                                                    <input type="text" name="nopendkereta" class="form-control" required>

                                                </div>
                                                <button type="submit" name="check" class="btn btn-success">Semak</button>
                                            </div>
                                            <br>
                                        </form>
                                    </div>
