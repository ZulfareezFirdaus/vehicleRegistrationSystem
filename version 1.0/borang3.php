...
<div id="wrapper">
    ...
    <!-- Page Content -->
                ...
                <div class="col-lg-18">
                    <h1> &nbsp; &nbsp; &nbsp;Laporan Kenderaan Pelajar</h1>
                    <br>
                        <!-- /.panel-heading -->
                <div class="row">
                    <div class="col-lg-30">
        ...
        <th>Lesen</th>
                    ...
                    $sql = "SELECT * FROM studentreport ORDER BY form";
		           ...
		           echo "<td>".$ro['phone_no_waris']."</td>";
                                        echo "<input type='text' style='display:none' name='phone_no_waris' value='".$ro['phone_no_waris']."'>";
		           ...
		           echo "<td>".$ro['nmapemilik']."</td>";
                                        echo "<input type='text' style='display:none' name='nmapemilik' value='".$ro['nmapemilik']."'>";
		           echo "<td>".$ro['pertalian']."</td>";
                                        echo "<input type='text' style='display:none' name='pertalian' value='".$ro['pertalian']."'>";
		           echo "<td>".$ro['lesen']."</td>";
