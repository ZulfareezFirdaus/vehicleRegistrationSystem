...
left: 30;
  ...
  transition-duration: 0.4s;
    ...
    <?php
    include("dbconn.php");
    if (isset($_POST['printfir']))
    {
      $sql0 = "SELECT * from studentreport WHERE ic_number = ".$_POST['printfir']."";
    ...
    <button class ="button" type="submit" id="print" onclick="printdiv('print_borang2');">Print  <i class="glyphicon glyphicon-print"></i></a> </button>
    <button class ="button1" type="submit" onclick="location.href = 'rfir.php'">Back <i class="glyphicon glyphicon-remove"></i></button> 
    <br><br>
