...
<html lang="en">
  ...
  <div id="page-wrapper">
      <div class="container-fluid">
          <div class="row">
              <div class="col-lg-12">
                  <h1 class="page-header">Pendaftaran Kenderaan Guru</h1>
              </div>
          </div>
      ...
      <div class="col-lg-6">
        <br><label>A.MAKLUMAT GURU</label><br><br>
          <form role="form" method="post" action="figProcess.php">
              
              <div>
 	<div class="form-group">
                                            <label>Kad Pengenalan</label>
                                            <input class="form-control" type="number" name="ic_numberTEC" value="" placeholder="Tanpa dash(-)" required>
                                            <p style="color:red"><b>*Pastikan NO.KAD PENGENALAN betul sebelum disahkan</b></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input class="form-control" type="text" name="nameTEC" value="" placeholder="" required>
                                        </div>                                     
                                        <div class="form-group">
                                            <label>Alamat Rumah</label>
                                            <input class="form-control" type="text" name="addressTEC" value="" placeholder="" required>
		         </div>

<div class="form-group">
                                            <label>No Telefon Guru</label>
                                            <input class="form-control" type="number" name="phone_noTEC" value="" placeholder="011012345678" required>
                                        </div>

                                       <div class="form-group">
                                            <label>Sessi</label>
                                            <select name="sessi" class="form-control" required>
                                                    <option value="-">-</option>
                                       ...
                                       <div class="form-group">
                                            <label>Jantina</label>
                                            <select name="genderTEC" class="form-control" required>
                                                    <option value="-">-</option>
...
<div class="form-group input-group">
              ...
              <div class="form-group input-group">
                  ...
                  <select type="text" name="kenderaanTEC" class="form-control" >
<option value="-">-</option>
